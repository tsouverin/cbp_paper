...
Because we use a different pinhole for the CBP response and the \SD response measurement, we must intercalibrate the CBP response with both pinholes. The CBP response $\Rcbp$ defined in Equation~\ref{eq:rsd} can be developed follows:
