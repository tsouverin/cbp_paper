...
% During the data acquisition campaign, we did not unplug and plug the optical fiber going from the integrating sphere to the spectrograph again. Such an action on the spectrograph side could have changed the wavelength calibration in principle, even if beforehand, we checked the fiber placement in the spectrograph was very reproducible and did not change the wavelength scale. 
