...
We start and end our measurements with a calibration of the spectrograph in. To do so, we plug a calibration Hg-Ar \com{??} lamp to the integrating sphere where the optic fiber of the spectrograph is plugged. This corresponds to the lines No.~1 and No.~13 of the Table~\ref{tab:schedule}.\\
