...
\todo{Elana : complementary sentences about the ampere box ? or rewriting...}
...
\begin{table*}[t]{}
    ...
    \begin{tabular}{M{.25cm} M{2.25cm} M{1.75cm} M{1.1cm} M{1.75cm} M{3cm} M{3.5cm} M{1.25cm}}
        \hline\hline
         \bf{N°} & \bf{Label} & \bf{Target} & \bf{Pinhole} & \bf{QSW} & \bf{StarDice bands} & \bf{Specitifity} & \bf{Number of runs} \\ 
         \hline
