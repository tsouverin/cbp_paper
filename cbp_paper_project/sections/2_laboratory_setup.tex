...
\label{sec:stardice}
\todo{Marc} 
The \SD photometric instrument (StarBot) consists in a Newton
...
features 6 interference filters in the $ugrizy$ photometric system, a Star Analyser 200 diffraction grating, and a \SI{0.2}{\milli\meter}
