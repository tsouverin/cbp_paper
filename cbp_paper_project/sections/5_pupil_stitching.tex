...
decrease of the transmission of the $r$ filter for the sample
...
considerations due to light incidence angle on the filter, highlighting the importance of including this effect
...
\begin{table}
  ...
  \begin{tabular}{@{}l@{}rrrrrr@{}}
    ...
    $\Esolar$ & 0.4 & 0.1 & 0.1 & 0.1 & 0.0 & 0.1 \\
